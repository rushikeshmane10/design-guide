  ...
  return (
    <>
      <PageHeader title="Post to X">
        <button
          onClick={handleReset}
          className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium text-muted-foreground transition-all duration-150 hover:bg-accent hover:text-foreground"
        >
          ...
          <div className="grid gap-8 lg:grid-cols-5">
            ...
            >
              {draft ? (
                ...
                <div className="rounded-xl border border-border bg-surface p-6 shadow-[var(--shadow-sm)]">
